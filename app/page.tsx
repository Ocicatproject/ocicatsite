    ...
    >
      ...
      <header className="w-full px-4 md:px-16 flex justify-between items-center bg-[#f0343d4d] fixed z-50 py-2 md:py-6">
        ...
        <div className="flex gap-4">
          <Link
            href="/x"
            className="bg-primary hover:bg-white/30  flex border-black border-2 px-4 py-3  items-center rounded-lg buttonshadow"
          >
            <X className="h-4 w-4 " />
          </Link>
          <Link
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center h-full">
          <div className="px-4 py-24">
            ...
            <div className="w-fit md:w-[70%] flex flex-row mt-5 justify-around gap-4 border-2 buttonshadow border-black bg-primary  py-4 md:px-4 px-8 rounded-lg">
              ...
              <button className="bg-primary hover:bg-white/30 rotate-12 flex border-black border-2 px-4 py-3 items-center rounded-lg buttonshadow">
        ...
        <div className="container px-4">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex gap-4">
              <Link
                href="/x"
                className="bg-[#f0343d] hover:bg-white/30  flex border-black border-2 px-4 py-3  items-center rounded-lg buttonshadow"
              >
                <X className="h-4 w-4 " />
              </Link>
              <Link
